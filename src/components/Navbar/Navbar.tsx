  ...
  return (
    loading ? (
      <div className="flex items-center justify-center h-screen w-screen">
        <div className='relative w-24 bg-red-300'>
          <div className='hiding-div w-2 absolute rotated-div'></div>
          <div className='w-1/3 h-full absolute right-1 hiding-div translate-left duration-300'></div>
          <img src={logo} alt="" />
        </div>
      </div>
    ) : (
